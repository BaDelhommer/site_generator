...
def markdown_to_html_node(markdown):
    ...
    return ParentNode("div", None, children)
...
def olist_to_html_node(block):
    ...
    for item in items:
        text = item[3:]
        children = text_to_children(text)
        html_items.append(ParentNode("li", None, children))
    return ParentNode("ol", None, html_items)
...
def ulist_to_html_node(block):
    ...
    for item in items:
        ...
        children = text_to_children(text)
        html_items.append(ParentNode("li", None, children))
    return ParentNode("ul", None, html_items)
